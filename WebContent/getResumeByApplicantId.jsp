...
<%
    ...
    String fileList = re.getResumeByApplicantId(request.getParameter("applicantId"), request.getSession().getServletContext().getInitParameter("upload-resume"));
%>
...
<body>
    ...
    <tr class="zebralinealter" style="height: 21px;">    
        <td><a target="_blank" href="<%=request.getContextPath()%>/Resume/<%=fileList%>"><%=fileList%></a></td>
    </tr>
</table>
