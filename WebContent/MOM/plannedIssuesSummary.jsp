...
<html>
    ...
    <body>
        <jsp:useBean id="pic" class="com.eminent.issue.formbean.PlannedIssueSummary"></jsp:useBean>
        <%pic.summary(request);%>
                ...
                <tbody>
                    ...
                    <tr class="zebraline" height="21">
                        ...
                        <td  class="background" title="<%=isfb.getType()%>"><a target="_blank" href="<%=request.getContextPath()%>/viewIssueDetails.jsp?issueid=<%=isfb.getIssueId()%>">
                                ...
                                <%=isfb.getIssueId()%></a>
                                <%
                                    if (pic.getCountType().equals("totPI") || pic.getCountType().equals("PI")) {                                        
                                        if (pic.getWrmIssueList().contains(isfb.getIssueId())) {%>
