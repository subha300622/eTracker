...
(function($) {
  $.widget("akottr.dragtable", {
    options: {
      ...
      maxMovingRows: 10,           // 1 -> only header. 40 row should be enough, the rest is usually not in the viewport
      excludeFooter: true,        // excludes the footer row(s) while moving other columns. Make sense if there is a footer with a colspan. */
