        ...
        <table cellpadding="0" cellspacing="0" width="100%">
            <tr border="2" bgcolor="#E8EEF7">
                <td bgcolor="#E8EEF7" border="1" align="left">
                    <font size="4" COLOR="#0000FF"> <b> ERM Analysis </b></font></td>
            </tr>
        </table>
    <%
        esr.getAll(request);
    ...
    <div >
        <table class="tablecontent">
            <thead>
                ...
                <tr >
                    <th  class="filter-select filter-match" data-placeholder="Select a State"><font><b>Location</b></FONT></th>
                                <%for (Map.Entry<String, Integer> skill : esr.getSkillwise().entrySet()) {%>
                    <TH  style="text-align: center;" data-placeholder="Try >=, <=,=,!= "><font><b><%=skill.getKey()%>&nbsp;&nbsp;(<%=skill.getValue()%>)</b></font></TH>
                                <%}%>
...
<script>
    $(document).on('click', '.ermsearch', function () {
        ...
        window.open("<%=request.getContextPath()%>/ERM/ermAnalysisDetail.jsp?location="+state+"&module="+skill+"&ermAnalysis=yes","_self");
    });
</script>
<style>
    .pager a.current {
