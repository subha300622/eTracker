...
<html>
    ...
    <body>
        ...
        <%
            mydeshboard.getDisplayIssue(request);
        ...
        <div class="tablecontent">
            ...
            <div>
                <div style="float:left;width: 80%">
                    Display total:<b><%=mydeshboard.getListIssueFormBean().size()%></b>  Issues with status <b><%= status%></b> and priority <b><%= priority%></b>
                </div>
            ...
            <TABLE width="100%" id="filtersort" class="tablesorter">
                <thead>
                    <TR style="background-color:#C3D9FF">
                        ...
                        <td width="12%" class="filter-false" ><font><b>Status</b></font></td>
                        <td width="8%" class="filter-false"><font><b>Due Date</b></font></td>
                        <td width="8%" class="filter-false" ><font><b>Modified On</b></font></td>
                ...
                <td class="background"  title="<%=issueFormBean.getType()%>"><%--<a  href="<%= request.getContextPath()%>/admin/dashboard/UpdateIssueview.jsp?issueNo=<%=issueFormBean.getIssueId()%>">--%><a href="javascript:callissue('<%=issueFormBean.getIssueId()%>')" style="visibility: visible"><%= issueFormBean.getIssueId()%></a></td>

                <%
                } else {
                %>
                <td  class="background"  title="<%=issueFormBean.getType()%>"><%--<a  href="<%= request.getContextPath()%>/Issuesummaryview.jsp?issueid=<%=issueFormBean.getIssueId()%>">--%><a href="javascript:callissue('<%=issueFormBean.getIssueId()%>')" style="visibility: visible"><%= issueFormBean.getIssueId()%></a></td>
                    <%
                        }
                    %>
                ...
                <td class="background" ><font face="Verdana, Arial, Helvetica, sans-serif"
                                              size="1" color="#000000"><%=issueFormBean.getModifiedOn()%> </font></td>
                <td class="background"><font
        ...
        <script type="text/javascript">
            ...
            function callissue(issueid) {
                ...
                if(roleId==1){
                     location.href = '<%= request.getContextPath()%>/admin/dashboard/UpdateIssueview.jsp?issueNo=' + issueid + '&sorton=' + sorton + '&sort_method=' + sort_method + '&userin=MyDashboard';
                }else{
                location.href = '<%= request.getContextPath()%>/Issuesummaryview.jsp?issueid=' + issueid + '&sorton=' + sorton + '&sort_method=' + sort_method + '&userin=MyDashboard'+"&priority="+priority+"&status="+status;
                }
            }
