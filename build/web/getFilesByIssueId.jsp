...
<jsp:useBean id="re" class="com.eminent.issue.controller.AttachFileController"></jsp:useBean>
<%
    List<FileAttachBean> fileList = re.getFilesByIssueId(request);
%>
...
<html>
    ...
    <body>
        ...
        <tr class="zebraline" style="height: 21px;background-color: #E8EEF7;">
            ...
            <td class="background"><a href="<%=request.getContextPath()%>/Etracker_AttachedFiles/<%=attch.getFileName()%>" target="_blank"><%=attch.getFileName()%></a></td>
            <td class="background"><%=attch.getStatus()%></td>
        </tr>
        <%}%>
    </table>
