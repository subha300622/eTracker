...
<body>
    <%        EscalationDAO escalationDAO = new EscalationDAOImpl();
        ...
        List<IssueFormBean> issues = new IssueDAOImpl().getMyassignmentissues(Integer.parseInt(userId));
        HashMap<Integer, String> member = GetProjectMembers.showUsersSName();
    %>
    <div class="tablecontent">
        <div>The below list shows <%=issues.size()%> issues</div>
        <TABLE width="100%" id="filtersort" class="tablesorter">
            <thead>
                <TR bgcolor="#C3D9FF">
                    ...
                    <td width="13%" data-placeholder="Select Creatd By"><font><b>Created By</b></font></td>
            ...
            <tbody>
                ...
                <tr class="zebraline" height="21">
                    ...
                    <td style="color: <%=escColor%>" class="background" ><%=member.get(Integer.parseInt(isfb.getCreatedBy()))%></td>
